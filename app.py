...
FUNKBRUECKE_DOWNLOAD_ARTEFAKTE = [
    ...
    },
    {
        ...
        "typ": "PDF",
        "beschreibung": "Kurzer Einstieg mit echten Programmansichten, vollbreitem Chat-Hauptfenster, Zielauswahl ALLE/Gegenstation, TX-Eingabe, frei wählbaren Windows-Audioquellen, Praxisanzeigen für Empfang, TX, Antwort und Abschluss, FB2-Praxisblock, im Ablauf nachgeführter Hardware-TX/RX-Abnahme, Feldnachweisvorschlag aus bestandener Abnahme, sichtbarem Sendemodus je TX-Paket inklusive Quelle und Rückfallmodus, FB2-Live-Ereignismonitor, Mesh-Modusentscheidung mit Primär-Hop und Ersatz-Hop, Mesh-Praxisfreigabe, FB2L-Webkarte für aktive Stationen, frische Nachbarlinks, Quelle, Rest-TTL und grau nachlaufende inaktive Stationen, FB2L-Baken in 2-FSK robust, bestätigten Nachbarmodi für Nutzpakete, FB2L-Prüfknopf im Mesh-Detailfenster, separatem Monitor für alle RX/TX-Daten, Geräte-, Automatik-, Detail-, Einstellungs- und Über-Fenster, FB1-Live-RX, FB2-Auto-RX mit Mehrfach-Duplikatmerker, Warteschlange, Start prüfen mit Empfang/Trockenlauf/echter CAT-PTT, harter FT-991A-Startkette mit Audio-Prüfhinweis statt Gerätebegrenzung, gleicher Sicherheitslinie in Vor-TX, Fehlerhilfe, Sendeautomatik und Feldtestprotokoll, automatischem RX nach TX, Auto-OK ohne manuelle PTT, robusteren Wiederholmodi nach NACK oder Timeout, Kern-Audiopfad von 2-FSK robust bis 16-MFSK, erweiterter Audio-QSO-Kette bis OFDM schnell, profilabhängiger FB2-Mesh-Automatik bis OFDM schnell, adaptive Moduskorrektur, A-B-C-Rückwegtest, Rückweg-ACK, 6-Hop-Praxisrundlauf und 6-Hop-Routenfreigabe über echte bidirektionale Nachbar-Feldnachweise.",
        "primär": False,
    },
    {
        "schlüssel": "changelog",
