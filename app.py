...
FUNKBRUECKE_DOWNLOAD_ARTEFAKTE = [
    ...
    },
    {
        ...
        "typ": "PDF",
        "beschreibung": "Kurzer Einstieg mit echten Programmansichten, FB1-Live-RX, FB2-Auto-RX, Warteschlange, Start prüfen, gehärteter Sendeautomatik, automatischem RX nach TX, Auto-OK, direkter Audio-QSO-Kette von 2-FSK bis 32-MFSK, FB2-Mesh-Automatik bis 16-MFSK, Rückweg-ACK, Fehlerantwort bis zum Ursprung, Feldnachweis-Sperre für automatische Mesh-Wiederholungen, 6-Hop-Praxisrundlauf, Mesh-Audio-Abnahme, Live-RX-Andockpunkt, Gesprächszustand, RX-Sortierung und wichtigsten Handgriffen.",
        "primär": False,
    },
    {
        "schlüssel": "changelog",
    ...
    },
    {
        ...
        "typ": "Markdown",
        "beschreibung": "Technischer Stand zur FB2-Modulation, Paketübertragung, Gesprächszustand, RX-Härtung, RX-Sortierung, FB2-Auto-RX mit Audiopufferprüfung, geprüfter Warteschlangen-Sendeautomatik, automatischem RX nach TX, direkter Audio-QSO-Kette von 2-FSK bis 32-MFSK, Timeout-Wiederholung, FB2-Mesh-Automatik bis 16-MFSK, Ende-zu-Ende-Zustellbestätigung, Fehlerantwort, Feldnachweis-Sperre für automatische Wiederholung und Ersatzroute, 6-Hop-Praxisrundlauf, Mesh-Audio-Abnahme, Live-RX-Andockpunkt und Ersatzroute.",
        "primär": False,
    },
    {
