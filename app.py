...
FUNKBRUECKE_DOWNLOAD_ARTEFAKTE = [
    ...
    },
    {
        ...
        "typ": "PDF",
        "beschreibung": "Kurzer Einstieg mit echten Programmansichten, FB1-Live-RX, FB2-Auto-RX, Warteschlange, gehärteter Sendeautomatik, Auto-OK, Audio-QSO-Kette von 2-FSK bis 32-MFSK, FB2-Mesh-Automatik bis 16-MFSK, Rückweg-ACK bis zum Ursprung, Praxisrundlauf, Mesh-Audio-Abnahme, Gesprächszustand, RX-Sortierung und wichtigsten Handgriffen.",
        "primär": False,
    },
    {
        "schlüssel": "changelog",
