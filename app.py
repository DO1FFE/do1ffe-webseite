...
FUNKBRUECKE_DOWNLOAD_ARTEFAKTE = [
    {
        ...
        "typ": "EXE",
        "beschreibung": "Aktuelle Windows-x64-Version mit gebündelter Laufzeit, eingebettetem FunkBrücke-Icon, entlastetem Mehrfenster-Aufbau und verzögerter Startnachladung.",
        "primär": True,
    },
    {
        "schlüssel": "bedienung",
        ...
        "typ": "PDF",
        "beschreibung": "Kurzer Einstieg mit echten Programmansichten, entlastetem Haupt-, Geräte- und Detailfenster, FB1-Live-RX, FB2-Auto-RX, Warteschlange, Start prüfen mit Empfang/Trockenlauf/echter CAT-PTT, Zwei-Stationen-Praxisstart, FT-991A-Hardwarepfad, gleicher Sicherheitslinie in Vor-TX, Fehlerhilfe, Sendeautomatik und Feldtestprotokoll, automatischem RX nach TX, Auto-OK, direkter Audio-QSO-Kette von 2-FSK bis 32-MFSK, FB2-Mesh-Automatikgrenze bis 16-MFSK, Rückweg-ACK, bidirektionalen Nachbar-Feldnachweisen, Fehlerantwort bis zum Ursprung, Feldnachweis-Sperre für automatische Mesh-Wiederholungen, 6-Hop-Praxisrundlauf, Mesh-Audio-Abnahme mit komprimierter 16-MFSK-Nutzlast, normalen Mesh-Live-Bedienhinweisen, Live-RX-Andockpunkt, Gesprächszustand, RX-Sortierung und wichtigsten Handgriffen.",
        "primär": False,
    },
    {
        "schlüssel": "changelog",
