...
FUNKBRUECKE_DOWNLOAD_ARTEFAKTE = [
    {
        ...
        "typ": "EXE",
        "beschreibung": "Aktuelle Windows-x64-Version mit gebündelter Laufzeit, eingebettetem FunkBrücke-Icon, leerem Startzustand ohne Beispielstationen, vollbreitem Chat-Hauptfenster mit Zielauswahl, frei wählbaren Windows-Audioquellen, sichtbarem Sendemodus je TX-Paket, strenger OK/Wiederholen-Zuordnung zum Test-TX, Dauer-RX-Duplikatschutz, FB2-Live-Ereignissen, nachvollziehbarer Mesh-Modusentscheidung, FB2L-Nachbarbaken mit Softwareversion, FB2L-Webkarten-Heartbeat für eigene Station und frische direkte Nachbarn, manuellem FB2L-Prüfheartbeat mit Zielhost- und Linkstatus, gehärtetem FB2L-Server, separatem Monitor für alle RX/TX-Daten, Geräte-, Automatik-, Detail-, Einstellungs- und Über-Fenstern sowie verzögerter CAT-/Audiogerätesuche nach dem sichtbaren Grundstart.",
        "primär": True,
    },
    {
        "schlüssel": "bedienung",
        ...
        "typ": "PDF",
        "beschreibung": "Kurzer Einstieg mit echten Programmansichten, vollbreitem Chat-Hauptfenster, Zielauswahl ALLE/Gegenstation, TX-Eingabe, frei wählbaren Windows-Audioquellen, sichtbarem Sendemodus je TX-Paket, FB2-Live-Ereignismonitor, Mesh-Modusentscheidung mit Primär-Hop und Ersatz-Hop, FB2L-Webkarte für aktive Stationen und frische Nachbarlinks, FB2L-Prüfknopf im Mesh-Detailfenster, separatem Monitor für alle RX/TX-Daten, Geräte-, Automatik-, Detail-, Einstellungs- und Über-Fenster, FB1-Live-RX, FB2-Auto-RX mit Duplikatschutz, Warteschlange, Start prüfen mit Empfang/Trockenlauf/echter CAT-PTT, FT-991A-Hardwarepfad mit Audio-Prüfhinweis statt Gerätebegrenzung, gleicher Sicherheitslinie in Vor-TX, Fehlerhilfe, Sendeautomatik und Feldtestprotokoll, automatischem RX nach TX, Auto-OK ohne manuelle PTT, Kern-Audiopfad von 2-FSK robust bis 16-MFSK, erweiterter Audio-QSO-Kette bis OFDM schnell, profilabhängiger FB2-Mesh-Automatik bis OFDM schnell, Rückweg-ACK und 6-Hop-Praxisrundlauf.",
        "primär": False,
    },
    {
        "schlüssel": "changelog",
