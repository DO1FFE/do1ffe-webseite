...
FUNKBRUECKE_DOWNLOAD_ARTEFAKTE = [
    {
        ...
        "typ": "EXE",
        "beschreibung": "Aktuelle Windows-x64-Version mit gebündelter Laufzeit, eingebettetem FunkBrücke-Icon, leerem Startzustand ohne Beispielstationen, vollbreitem Chat-Hauptfenster mit Zielauswahl, frei wählbaren Windows-Audioquellen, Praxisanzeigen für Empfang, TX, Antwort und Abschluss, FB2-Praxisblock, im Ablauf nachgeführter Hardware-TX/RX-Abnahme, gespeichertem mesh-tauglichem Feldnachweis aus bestandener Abnahme, sichtbarem Sendemodus je TX-Paket inklusive Quelle und Rückfallmodus, strenger OK/Wiederholen-Zuordnung zum Test-TX, strenger FB2-Modusprobe und Modusantwort mit Profilprüfung, FB2-RX-Pipeline mit Mehrfach-Duplikatmerker, Echo-/Direkt-/Rundruf-/Mesh-Klassifikation, harter letzter Kanalfreigabe, robusteren Wiederholmodi nach NACK oder Timeout, FB2-Live-Ereignissen, nachvollziehbarer Mesh-Modusentscheidung, Mesh-Praxisfreigabe vor dem Einreihen, externer Feldnachweis-Route vor dem Mesh-Rundlauf, adaptiver Moduskorrektur vor dem Rahmenbau, FB2L-Baken in 2-FSK robust, bestätigter Nachbarmodusnutzung, harter FT-991A-Startkette, 6-Hop-Routenfreigabe über echte bidirektionale Nachbar-Feldnachweise mit korrektem letzten Rest-Hop, vorab geprüftem FB2L-Webkarten-Heartbeat für eigene Station und frische direkte Nachbarn, grauer FB2L-Nachlaufanzeige für inaktive Stationen, Quelle- und Rest-TTL-Anzeige in der FB2L-Karte, manuellem FB2L-Prüfheartbeat mit Zielhost- und Linkstatus, gehärtetem FB2L-Server, separatem Monitor für alle RX/TX-Daten, Geräte-, Automatik-, Detail-, Einstellungs- und Über-Fenstern sowie verzögerter CAT-/Audiogerätesuche nach dem sichtbaren Grundstart.",
        "primär": True,
    },
    {
        "schlüssel": "bedienung",
        ...
        "typ": "PDF",
        "beschreibung": "Kurzer Einstieg mit echten Programmansichten, vollbreitem Chat-Hauptfenster, Zielauswahl ALLE/Gegenstation, TX-Eingabe, frei wählbaren Windows-Audioquellen, Praxisanzeigen für Empfang, TX, Antwort und Abschluss, FB2-Praxisblock, im Ablauf nachgeführter Hardware-TX/RX-Abnahme, gespeichertem mesh-tauglichem Feldnachweis aus bestandener Abnahme, sichtbarem Sendemodus je TX-Paket inklusive Quelle und Rückfallmodus, FB2-Live-Ereignismonitor, Mesh-Modusentscheidung mit Primär-Hop und Ersatz-Hop, Mesh-Praxisfreigabe, externer Feldnachweis-Route, FB2L-Webkarte für aktive Stationen, frische Nachbarlinks, Quelle, Rest-TTL und grau nachlaufende inaktive Stationen, vorab geprüften FB2L-Heartbeats, FB2L-Baken in 2-FSK robust, bestätigten Nachbarmodi für Nutzpakete, FB2L-Prüfknopf im Mesh-Detailfenster, separatem Monitor für alle RX/TX-Daten, Geräte-, Automatik-, Detail-, Einstellungs- und Über-Fenster, FB1-Live-RX, FB2-Auto-RX mit Mehrfach-Duplikatmerker, Warteschlange, Start prüfen mit Empfang/Trockenlauf/echter CAT-PTT, harter FT-991A-Startkette mit Audio-Prüfhinweis statt Gerätebegrenzung, gleicher Sicherheitslinie in Vor-TX, Fehlerhilfe, Sendeautomatik und Feldtestprotokoll, automatischem RX nach TX, Auto-OK ohne manuelle PTT, robusteren Wiederholmodi nach NACK oder Timeout, Kern-Audiopfad von 2-FSK robust bis 16-MFSK, erweiterter Audio-QSO-Kette bis OFDM schnell, profilabhängiger FB2-Mesh-Automatik bis OFDM schnell, adaptive Moduskorrektur, A-B-C-Rückwegtest, Rückweg-ACK, 6-Hop-Praxisrundlauf und 6-Hop-Routenfreigabe über echte bidirektionale Nachbar-Feldnachweise.",
        "primär": False,
    },
    {
        "schlüssel": "changelog",
    ...
    },
    {
        ...
        "typ": "Markdown",
        "beschreibung": "Technischer Stand zur FB2-Modulation, Paketübertragung, Broadcast-Ziel ALLE ohne automatisches OK/ACK, Praxisstartstufe, echter CAT-PTT, Zwei-Stationen-Praxisstart, FB2-Praxisblock, Hardware-TX/RX-Abnahme, gespeichertem mesh-tauglichem Feldnachweis aus bestandener Abnahme, frei wählbaren Audioquellen mit Prüfhinweis vor echter HF, gemeinsamer Sicherheitslinie für Vor-TX, Fehlerhilfe, Sendeautomatik und Feldtestprotokoll, Gesprächszustand, RX-Härtung, RX-Sortierung, FB2-Auto-RX mit Audiopufferprüfung, Mehrfach-Duplikatmerker, Echo-/Direkt-/Rundruf-/Mesh-Klassifikation, geprüfter Warteschlangen-Sendeautomatik ohne manuelle PTT, harter letzter Kanalfreigabe, automatischem RX nach TX, FB2-Live-Ereignissen, sichtbarem Sendemodus je TX-Paket, strenger Modusprobe und Modusantwort, robusteren Wiederholmodi nach NACK oder Timeout, Kern-Audiopfad von 2-FSK robust bis 16-MFSK, erweiterter Audio-QSO-Kette bis OFDM schnell, FB2L-Link-Baken in 2-FSK robust mit Softwareversion, bestätigter Nachbarmodusnutzung für Nutzpakete, vorab geprüftem FB2L-Webkarten-Heartbeat mit Station, Version, Modus, Linkwerten, Quelle und Rest-TTL, grauem FB2L-Nachlauf ohne alte Links, manuellem FB2L-Prüfheartbeat, gehärtetem FB2L-Ingest, Timeout-Wiederholung, strenger Rückmeldeprüfung, automatischer RX-/Kanalvorbereitung beim Einreihen, profilabhängiger FB2-Mesh-Automatik bis OFDM schnell, Mesh-Praxisfreigabe vor dem Einreihen, externer Feldnachweis-Route, nachvollziehbarer Primär-/Ersatz-Hop-Moduswahl, adaptiver Moduskorrektur, letzter passender Nachbarspur, Ende-zu-Ende-Zustellbestätigung, A-B-C-Rückwegtest, 6-Hop-Praxisrundlauf und korrektem letzten Rest-Hop.",
        "primär": False,
    },
    {
