...
FUNKBRUECKE_DOWNLOAD_ARTEFAKTE = [
    ...
    },
    {
        ...
        "typ": "PDF",
        "beschreibung": "Kurzer Einstieg mit echten Programmansichten, vollbreitem Chat-Hauptfenster, Zielauswahl ALLE/Gegenstation, TX-Eingabe, frei wählbaren Windows-Audioquellen, sichtbarem Sendemodus je TX-Paket, FB2-Live-Ereignismonitor, Mesh-Modusentscheidung mit Primär-Hop und Ersatz-Hop, FB2L-Webkarte für aktive Stationen, frische Nachbarlinks und grau nachlaufende inaktive Stationen, FB2L-Baken in 2-FSK robust, bestätigten Nachbarmodi für Nutzpakete, FB2L-Prüfknopf im Mesh-Detailfenster, separatem Monitor für alle RX/TX-Daten, Geräte-, Automatik-, Detail-, Einstellungs- und Über-Fenster, FB1-Live-RX, FB2-Auto-RX mit Duplikatschutz, Warteschlange, Start prüfen mit Empfang/Trockenlauf/echter CAT-PTT, FT-991A-Hardwarepfad mit Audio-Prüfhinweis statt Gerätebegrenzung, gleicher Sicherheitslinie in Vor-TX, Fehlerhilfe, Sendeautomatik und Feldtestprotokoll, automatischem RX nach TX, Auto-OK ohne manuelle PTT, Kern-Audiopfad von 2-FSK robust bis 16-MFSK, erweiterter Audio-QSO-Kette bis OFDM schnell, profilabhängiger FB2-Mesh-Automatik bis OFDM schnell, A-B-C-Rückwegtest, Rückweg-ACK und 6-Hop-Praxisrundlauf.",
        "primär": False,
    },
    {
        "schlüssel": "changelog",
