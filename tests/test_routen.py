...
def test_funkbruecke_seite_zeigt_aktuellen_prototypstand():
    ...
    erwartete_texte = [
        ...
        "Der Nutzer liest den Chatverlauf",
        "separaten Monitor",
        "Chat-Hauptfenster mit Zielauswahl",
        "Automatikfenster",
        ...
        "Prüfhinweis bei untypischem Audioweg",
        ...
        "Anzahl der Warteschlangenaufträge",
        ...
        "strenger FB2-Modusprobe und Modusantwort",
        "Probe-/Antwortdaten in 2-FSK robust",
        "Mesh-Praxisfreigabe",
        "Mesh-Warteschlangeneintrag mit Feldnachweis-ID",
        "Feldnachweis-ID",
        "belegte Nachbarverbindung",
        "FB2-Mesh-Automatik",
        "Rückweg-ACK",
        "A-B-C-Fall",
        "6-Hop-Praxisrundlauf",
        "korrektem letzten Rest-Hop",
        "Standard-Hopzahl",
        "6-Hop-Freigabe",
        "Nachbar-Feldnachweis",
        "Mesh-Audio-Abnahme",
