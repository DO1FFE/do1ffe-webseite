...
def test_funkbruecke_seite_zeigt_aktuellen_prototypstand():
    ...
    erwartete_texte = [
        ...
        "ohne Audioeingang, Audioausgang oder FB2-Dauer-RX bleibt der Auftrag in der Warteschlange",
        "Nach TX meldet die Oberfläche",
        ...
        "A-D-Relaisfall über",
        "Hop-Warteschlangen",
        "freie TX-Lage und Audio-I/O",
        "RX/TX-Bereitschaft nicht für automatische Mesh-Weiterleitung",
