...
def test_funkbruecke_seite_zeigt_aktuellen_prototypstand():
    ...
    erwartete_texte = [
        ...
        "v0.9.",
        "Text schreiben, Ziel wählen, in die Warteschlange legen",
        "Windows-Prototyp",
        "Chat",
        "Warteschlange",
        "FT-991A",
        ...
        "Mesh-Routen brauchen bestätigte Nachbarwege",
        "Vor TX wird auf gültige FB-Signale gehört",
        ...
        "MFSK",
        "OFDM",
        "Anleitung und technische Unterlagen",
        "Locator",
        "funkbruecke-logo.png",
        "funkbruecke-uebersicht.png",
        "funkbruecke-mesh-karte.png",
        "funkbruecke-wasserfall.png",
    ]
